...
class GDVersion:
    ...
    def __repr__(self) -> str:
        return f"<GDVersion {str(self)} ({self.bin_ver})>"
    ...
    def determine_device_type(self) -> version.DeviceType:
        ...
        if self.major == 1 and self.minor < 9:
            return version.DeviceType.MOBILE
        # 2.13 has different bin vers for PC and mobile.
        elif self.bin_ver == 34:
            return version.DeviceType.PC
        elif self.bin_ver == 35:
            return version.DeviceType.MOBILE
